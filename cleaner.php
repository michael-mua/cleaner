...
// echo "$wambua_corrupted_employee";
$aur_array = explode(PHP_EOL,$wambua_corrupted_employee);
echo '<table border = "1">';
foreach ($aur_array as $row)
{
  echo '<tr><td>$wambua_corrupted_employee$</td></tr>';
}
...
echo clean($wambua_corrupted_employee);
echo '</table>';
 ?>
